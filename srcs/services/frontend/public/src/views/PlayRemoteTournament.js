import BasePlayViewTournament from "./BasePlayViewTournament.js";

let keys = { a: false, d: false, ArrowLeft: false, ArrowRight: false };
let isRunning = false;

export default class PlayCanva extends BasePlayViewTournament {
	constructor(params) {
		super(params);
	...
	attachEvents() {
		console.log("Events attached (PlayCanva Tournament)");
