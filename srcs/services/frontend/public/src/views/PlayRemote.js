...
export default class PlayCanva extends BasePlayView {
	...
	initGame() {
		...
		this.meshPlayer1.position.set((this.player1.x - this.centerX), (this.player1.y - this.centerY), 20);
		...
		this.meshBall.position.set((this.ball.x - this.centerX), (this.ball.y - this.centerY), 16);
