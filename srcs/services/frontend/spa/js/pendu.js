...
export default function() {
  if (ready) {
    ...
    const htmlContent = `
      <h1>Le pendu</h1>
      <img src="../media/hanging.jpg" alt="Profile picture" class="profile-img">
    ...
    const socket = new WebSocket('wss://' + window.location.host + '/ws/pendu/' + 'lol/');
    ...
    socket.onmessage = function(event) {
      ...
      if (messageElement) messageElement.textContent = data.word || messageElement.textContent;
    };
